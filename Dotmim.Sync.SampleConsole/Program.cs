...
internal class Program
{
    ...
    private static async Task Main(string[] args)
    {
        ...
        var proFilter = new SetupFilter("Product");
        proFilter.AddParameter("Color", "Product", false);
        proFilter.AddWhere("Color", "Product", "Color");
        proFilter.AddParameter("ProductCategoryID", "Product", false);
        proFilter.AddWhere("ProductCategoryID", "Product", "ProductCategoryID");
        setup.Filters.Add(proFilter);


        //var p0 = new SyncParameters { { "Color", "Red" }, { "ProductCategoryID", "5515f857-075b-4f9a-87b7-43b4997077b3" } };
        //var resultP0 = await agent.SynchronizeAsync(setup, p0);
        //Console.WriteLine(resultP0);
        //var clientConnection = clientProvider.CreateConnection();
        //var productRows = await clientProvider.GetDatabaseBuilder().GetTableAsync("ProductCategory", null, clientConnection);
        //Console.WriteLine($"rows: {productRows.Rows.Count}");


        //var p1 = new SyncParameters { { "Color", "Black" }, { "ProductCategoryID", "5515f857-075b-4f9a-87b7-43b4997077b3" } };
        //var resultP1 = await agent.SynchronizeAsync(setup, p1);
        //Console.WriteLine(resultP1);
        //var clientConnection1 = clientProvider.CreateConnection();
        //var productRows1 = await clientProvider.GetDatabaseBuilder().GetTableAsync("ProductCategory", null, clientConnection1);
        //Console.WriteLine($"rows: {productRows1.Rows.Count}");


        var p2 = new SyncParameters { { "Color", "Silver" }, { "ProductCategoryID", "61b21b65-e16a-4be7-9300-4d8e9db861be" } };
        var resultP2 = await agent.SynchronizeAsync(setup, p2);
        Console.WriteLine(resultP2);

        var clientConnection2 = clientProvider.CreateConnection();
        var productRows2 = await clientProvider.GetDatabaseBuilder().GetTableAsync("ProductCategory", null, clientConnection2);
        Console.WriteLine($"rows: {productRows2.Rows.Count}");
...
////C:\Users\sojan.GEROC\Downloads\New folder\Dotmim.Sync-master
...
////var setup = new SyncSetup("ProductCategory", "ProductDescription", "ProductModel", "Product");
//var setup = new SyncSetup("ProductCategory", "Product");
////var setup = new SyncSetup("Product");
...
//// setup.Filters.Add("Product", "Color");


////var proFilter = new SetupFilter("ProductCategory");
////proFilter.AddParameter("Name", "ProductCategory", false);
////proFilter.AddWhere("Name", "ProductCategory", "Name");
////setup.Filters.Add(proFilter);
...
//    // P0 : Color: "Red"
//    //var p0 = new SyncParameters { { "Color", "Red" } };

//     var p0 = new SyncParameters { { "Color", "Red" }, { "ProductCategoryID", "5515f857-075b-4f9a-87b7-43b4997077b3" } };
////var p0 = new SyncParameters { { "Color", "Black" }, { "ProductCategoryID", "5515f857-075b-4f9a-87b7-43b4997077b3" } };
////  var p0 = new SyncParameters { { "Color", "Silver" }, { "ProductCategoryID", "61b21b65-e16a-4be7-9300-4d8e9db861be" } };

////var p0 = new SyncParameters { { "Name", "Bikes" },{ "Name", "Shoes" }

////};

//// var p0 = new SyncParameters();

////SyncParameter p1 = new SyncParameter();
////p1.Name = "Name";
////p1.Value = "Accessories";
////p0.Add(p1);
...
//// P1 : Color: "Black"
//var p1 = new SyncParameters { { "Color", "Black" } };
//var resultP1 = await agent.SynchronizeAsync(setup, p1);
//Console.WriteLine(resultP1);

//productRows = await clientProvider.GetDatabaseBuilder().GetTableAsync("Product", null, clientConnection);
//Console.WriteLine($"rows: {productRows.Rows.Count}");



//// P2 : Color: "Black"
//var p2 = new SyncParameters { { "Color", "Silver" } };
//var resultP2 = await agent.SynchronizeAsync(setup, p2);
//Console.WriteLine(resultP2);
